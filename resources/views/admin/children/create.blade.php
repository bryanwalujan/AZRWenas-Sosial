...
<head>
    ...
    <title>Tambah Anak - {{ $orphanage->name }}</title>
        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold">Tambah Anak</h1>
    ...
    <main class="container mx-auto px-6 py-8">
        ...
        <div class="mb-8 fade-in">
            <div class="flex items-center space-x-2 text-sm text-gray-500 mb-3">
                <a href="{{ route('admin.orphanages.index') }}" class="hover:text-primary transition-colors">
                    <i class="fas fa-home"></i>
                    <span>Daftar Panti</span>
                </a>
                <i class="fas fa-chevron-right text-xs"></i>
                <a href="{{ route('admin.orphanages.children.index', $orphanage) }}" class="hover:text-primary transition-colors">
                    <span>Data Anak</span>
                </a>
                <i class="fas fa-chevron-right text-xs"></i>
                <span class="text-gray-700 font-medium">Tambah Anak</span>
            </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Lengkapi data anak untuk {{ $orphanage->name }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="section-card fade-in">
            ...
            <form action="{{ route('admin.orphanages.children.store', $orphanage) }}" method="POST" class="section-body">
                @csrf
                
                <!-- Include form fields from _form.blade.php -->
                @include('admin.children._form', ['child' => null])
                
                <!-- Action Buttons -->
                <div class="flex flex-col sm:flex-row gap-3 mt-8 pt-6 border-t border-gray-100">
                    <button type="submit" 
                            class="flex items-center justify-center space-x-2 bg-gradient-to-r from-success to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 py-3 rounded-lg shadow-md transition-all duration-300 card-hover">
