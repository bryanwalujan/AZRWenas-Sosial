...
<head>
    ...
    <title>Tambah Kebutuhan - {{ $orphanage->name }}</title>
        ...
        <nav class="flex mb-6 fade-in" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Tambah Kebutuhan</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 fade-in">
                <div class="bg-white rounded-xl shadow-md overflow-hidden card-hover">
                    ...
                    <div class="p-6">
                        <form action="{{ route('admin.orphanages.needs.store', $orphanage) }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-8">
                                ...
                                <textarea name="description" rows="4"
                                          class="w-full form-input px-4 py-3 rounded-lg focus:outline-none"
                                          placeholder="Tambahkan keterangan tentang kebutuhan ini">{{ old('description') }}</textarea>
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 pt-4 border-t border-gray-200">
                                <button type="submit"
                                        class="flex-1 flex items-center justify-center btn-primary text-white px-5 py-3 rounded-lg font-medium shadow-md">
                    ...
                    <div class="p-4">
                        <ul class="space-y-3 text-sm text-gray-600">
                            <li class="flex items-start">
                                ...
                                <span>Gunakan nama kebutuhan yang jelas dan spesifik</span>
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                                <span>Tambahkan keterangan untuk informasi lebih detail</span>
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                                <span>Pastikan data yang dimasukkan sudah benar</span>
                            </li>
                        </ul>
                    </div>
                </div>
